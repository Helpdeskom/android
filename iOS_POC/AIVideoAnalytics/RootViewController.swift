...
class RootViewController: UIViewController {
  ...
  @IBOutlet weak var bottomViewHeightConstraint: NSLayoutConstraint!
    ...
    @IBOutlet weak var lblMotercycleCount: UILabel!
    @IBOutlet weak var lblPersonCount: UILabel!
    @IBOutlet weak var lblCarsCount: UILabel!
  ...
  private func updateMediaLibraryControllerUI() {
    guard let mediaLibraryViewController = mediaLibraryViewController else {
      ...
      mediaLibraryViewController.rootVC = self
    ...
    @IBAction func homeBtn(_ sender: Any) {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
           let destinationVC = storyboard.instantiateViewController(withIdentifier: "DashboardVC")
