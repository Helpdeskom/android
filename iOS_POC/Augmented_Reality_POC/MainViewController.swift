...
class MainViewController: UIViewController {
	...
	func restartPlaneDetection() {
		...
		textManager.scheduleMessage("FIND A SURFACE TO PLACE AN OBJECT", inSeconds: 6.5, messageType: .planeEstimation)
	}
...
extension MainViewController: VirtualObjectSelectionViewControllerDelegate {
	...
	func loadVirtualObject(object: VirtualObject) {
		...
		spinner.bounds.size = CGSize(width: addObjectButton.bounds.width - 6, height: addObjectButton.bounds.height - 6)
